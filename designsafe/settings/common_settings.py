...
# TAPIS v3 Tenant Configuration
TAPIS_TENANT_ID = os.environ.get('TAPIS_TENANT_ID')
TAPIS_TENANT_BASEURL = os.environ.get('TAPIS_TENANT_BASEURL')
TAPIS_TENANT_USER = os.environ.get('TAPIS_TENANT_USER')
TAPIS_TENANT_PASS = os.environ.get('TAPIS_TENANT_PASS')
