...
CELERY_BROKER_URL = "".join(
    [
        CELERY_BROKER_URL_PROTOCOL,
        CELERY_BROKER_URL_USERNAME,
        ":",
        CELERY_BROKER_URL_PWD,
        "@",
        CELERY_BROKER_URL_HOST,
        ":",
        CELERY_BROKER_URL_PORT,
        "/",
        CELERY_BROKER_URL_VHOST,
    ]
)
# CELERY_BROKER_URL = 'amqp://designsafe:pwd@rabbitmq:5672//'
CELERY_RESULT_BACKEND_PROTOCOL = os.environ.get(
    "CELERY_RESULT_BACKEND_PROTOCOL", "redis://"
)
CELERY_RESULT_BACKEND_USERNAME = os.environ.get(
...
CELERY_WORKER_LOG_FORMAT = (
    "[DJANGO] $(processName)s %(levelname)s %(asctime)s %(module)s "
