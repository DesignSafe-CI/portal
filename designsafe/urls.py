...
urlpatterns = [
    ...
    url(
        r"^rw/workspace/",
        include(("designsafe.apps.workspace.urls", "designsafe.apps.workspace")),
    ),
    path(
        "api/workspace/",
    ...
    url(
        r"^onboarding/",
        include(
            ("designsafe.apps.onboarding.urls", "designsafe.apps.onboarding"),
    ...
    path(
        "api/onboarding/",
        include(
            "designsafe.apps.onboarding.api.urls", namespace="designsafe_onboarding_api"
        ),
    ),
    # dashboard
    url(
