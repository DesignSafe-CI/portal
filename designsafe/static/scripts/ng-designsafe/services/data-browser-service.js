  ...
  */
  function containsFolder(files) {
    ...
    var tests = {};
      ...
      tests.canViewMetadata = files.length >= 1 && hasPermission('READ', files) && !['publicData', 'publishedData.view', 'communityData', 'neesPublishedData'].includes($state.current.name);
