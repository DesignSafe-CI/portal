...
class PipelineSelectionFieldReconCtrl {
    ...
    goPreview() {
        this.$state.go('projects.previewFieldRecon', {projectId: this.projectId}, {reload: true});
    }
...
export const PipelineSelectionFieldReconComponent = {
    template: PipelineSelectionFieldReconTemplate,
    controller: PipelineSelectionFieldReconCtrl,
    controllerAs: '$ctrl',
    bindings: {
        resolve: '<',
        close: '&',
