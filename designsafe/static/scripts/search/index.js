...
searchModule.requires.push('ngSanitize', 'ui.router');

angular.module('designsafe.portal').requires.push('ds-search');

function config($httpProvider, $locationProvider, $stateProvider, $urlMatcherFactoryProvider) {
