...
def mytickets(request):
    ...
    context = {"tickets": tickets, "show_resolved": show_resolved}
    if fmt == "json":
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            meta = (
                ...
                (
                    "Category",
                    dict(settings.TICKET_CATEGORIES)[form.cleaned_data["category"]],
                ),
                ("Resource", "DesignSafe"),
            )
            ...
            messages.error(
                request,
                "You ticket is missing some information. "
...
def ticketreply(request, ticketId):
    ...
    return render(
        ...
        {"ticket_id": ticketId, "ticket": ticket, "form": form},
    )
...
class FeedbackView(BaseApiView):
    def post(self, request):
        ...
        if ticket_id > -1:
            ...
            return ApiException(
                status=400, message="There was a problem submittin your ticket."
            )
