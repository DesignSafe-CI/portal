...
urlpatterns = [
    ...
    path(
        ...
        views.get_portal_audit_search,
        name="get_portal_audit_search",
    ),
    path(
        "api/user/<str:filename>/tapis/",
        views.get_tapis_files_audit_search,
        name="get_tapis_files_audit_search",
    ),
    path(
