...
class TestPrivateDataSearchMgr(TestCase):
    @patch(
        "designsafe.apps.api.search.searchmanager.private_data.BaseSearchManager.__init__"
    )
...
class TestCommunitySearchMgr(TestCase):
    @patch(
        "designsafe.apps.api.search.searchmanager.community.BaseSearchManager.__init__"
    )
    def test_init(self, mock_base):
        request = MagicMock()
        request.query_string = "test_query"
...
class TestPublishedDataSearchMgr(TestCase):
    @patch(
        "designsafe.apps.api.search.searchmanager.published_files.BaseSearchManager.__init__"
    )
    def test_init(self, mock_base):
        request = MagicMock()
        request.query_string = "test_query"
...
class TestPublicationSearchMgr(TestCase):
    @patch(
        "designsafe.apps.api.search.searchmanager.publications.BaseSearchManager.__init__"
    )
    def test_init(self, mock_base):
        request = MagicMock()
        request.query_string = "test_query"
    ...
    @patch(
        "designsafe.apps.api.search.searchmanager.publications.BaseESPublicationLegacy"
    )
