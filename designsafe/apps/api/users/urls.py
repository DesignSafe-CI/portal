...
from designsafe.apps.api.users.views import SearchView, AuthenticatedView, UsageView, ProjectUserView, PublicView, SUAllocationsView
...
urlpatterns = [
    ...
    path('allocations/', SUAllocationsView.as_view(), name='su_allocations'),
]
