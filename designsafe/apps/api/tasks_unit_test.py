...
TEST_PROJECT = {
    "uuid": "6262924605326814745-242ac11c-0001-012",
    "schemaId": None,
    ...
    "created": "2018-01-18T11:04:35.636-06:00",
    "owner": "ds_admin",
...
class TestProjectIndexer(TestCase):
    ...
    def test_project_listing(self, mock_client):
        ...
        mock_client().meta.listMetadata.assert_called_with(
            q='{"name": "designsafe.project"}', offset=0, limit=100
        )
    ...
    def test_index_or_update_project(self, mock_indexer, mock_client):
        ...
        mock_client().meta.listMetadata.assert_called_with(
            q='{"uuid": "test-uuid"}', offset=0, limit=1
        )
