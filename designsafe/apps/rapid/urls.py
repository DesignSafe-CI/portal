...
urlpatterns = patterns(
    ...
    url(r'^admin/users/permissions?$', 'admin_user_permissions', name="admin_user_permissions"),
    ...
    url(r'^admin/events/(?P<event_id>[-\w]+)/datasets$', 'admin_event_datasets', name="admin_event_datasets"),
    ...
    url(r'^admin/events/(?P<event_id>[-\w]+)/(?P<dataset_id>[-\w]+)/delete$', 'admin_event_delete_dataset', name="admin_event_delete_dataset"),
