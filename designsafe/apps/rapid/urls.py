...
urlpatterns = [
    ...
    url(
        ...
        views.admin_user_permissions,
        name="admin_user_permissions",
    ),
    url(r"^admin/create-event", views.admin_create_event, name="admin_create_event"),
    url(
        r"^admin/events/(?P<event_id>[-\w]+)/delete$",
        views.admin_delete_event,
        name="admin_delete_event",
    ),
    url(
        r"^admin/events/(?P<event_id>[-\w]+)/$",
        views.admin_edit_event,
        name="admin_edit_event",
    ),
    url(
        r"^admin/events/(?P<event_id>[-\w]+)/datasets$",
        views.admin_event_datasets,
        name="admin_event_datasets",
    ),
    url(
        r"^admin/events/(?P<event_id>[-\w]+)/add-dataset/$",
        views.admin_event_add_dataset,
        name="admin_event_add_dataset",
    ),
    url(
        r"^admin/events/(?P<event_id>[-\w]+)/(?P<dataset_id>[-\w]+)/$",
        views.admin_event_edit_dataset,
        name="admin_event_edit_dataset",
    ),
    url(
        r"^admin/events/(?P<event_id>[-\w]+)/(?P<dataset_id>[-\w]+)/delete$",
        views.admin_event_delete_dataset,
