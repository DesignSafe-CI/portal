...
urlpatterns = [
    ...
    url(
        r"^authentication/$", views.manage_authentication, name="manage_authentication"
    ),
    ...
    url(
        r"^nees-account/(?:(?P<step>\d+)/)?$",
        views.nees_migration,
        name="nees_migration",
    ),
    url(
    ...
    url(
        r"^activate/(?:(?P<code>.+)/)?$",
        views.email_confirmation,
        name="email_confirmation",
    ),
    url(
        r"^mailing-list/(?P<list_name>.*)/$",
        views.mailing_list_subscription,
        name="mailing_list_subscription",
    ),
    url(r"^user-report/(?P<list_name>.*)/$", views.user_report, name="user_report"),
