...
class DataConfig(AppConfig):
    ...
    def ready(self):  # pylint:disable=too-many-locals
        ...
        from designsafe.apps.projects.models.agave.experimental import (  # noqa: F401
            ExperimentalProject,
            FileModel as ExpFileModel,
            DataTag as ExpDataTag,
            Experiment,
            Analysis,
            ModelConfig,
            SensorList,
        ...
        from designsafe.apps.projects.models.agave.simulation import (  # noqa: F401
            SimulationProject,
            FileModel as SimFileModel,
            DataTag as SimDataTag,
            Simulation,
            Model,
            Input,
            Output,
        ...
        from designsafe.apps.projects.models.agave.hybrid_simulation import (  # noqa: F401
            ...
            FileModel as HybFileModel,
            DataTag as HybDataTag,
            HybridSimulation,
            GlobalModel,
            Coordinator,
            SimSubstructure,
            ...
            SimOutput,
            ExpOutput,
            Analysis as HybAnalysis,
            Report as HybReport,
        )
        from designsafe.apps.projects.models.agave.rapid import (  # noqa: F401
            FieldReconProject,
            FileModel as FRFileModel,
            DataTag as FRDataTag,
            Mission,
            Instrument,
            ReferencedData,
            Collection,
