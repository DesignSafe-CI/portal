...
def walk_fr(project_id, version=None):
    ...
    for document in docs_list:
        ...
        project_map['fedora_mapping']['generated'].append('Documents: {}'.format(doc_doi))
    ...
    for mission in missions_list:
        ...
        project_map['fedora_mapping']['generated'].append('Mission: {}'.format(mission_doi))
        ...
        for collection in collections:
            ...
            collection_container_path = "{}/{}".format(mission_container_path, parse.quote(collection.value.title))
            print('\tcollection ' + collection.value.title)
            mission_map['fedora_mapping']['generated'].append('Collection: {}'.format(collection.value.title))
        ...
        for geo_collection in geoscience:
            # Do stuff with report.
            geo_container_path = "{}/{}".format(mission_container_path, parse.quote(geo_collection.value.title))
            print('\tgeo collection ' + geo_collection.value.title)
            mission_map['fedora_mapping']['generated'].append('Engineering/Geosciences Collection: {}'.format(geo_collection.value.title))
        ...
        for soc_collection in socialscience:
            # Do stuff with report.
            soc_container_path = "{}/{}".format(mission_container_path, parse.quote(soc_collection.value.title))
            print('\tsoc collection ' + soc_collection.value.title)
            mission_map['fedora_mapping']['generated'].append('Social Sciences Collection: {}'.format(soc_collection.value.title))
        ...
        for planning_coll in planning:
            # Do stuff with report.
            planning_container_path = "{}/{}".format(mission_container_path, parse.quote(planning_coll.value.title))
            print('\tplanning collection ' + planning_coll.value.title)
            mission_map['fedora_mapping']['generated'].append('Social Sciences Collection: {}'.format(planning_coll.value.title))
...
def format_soc(soc):
    ...
    author_list = list(map(format_member,
                       soc.value.dataCollectors))
