  ...
  const rules = useMemo(
    function () {
      ...
      return {
        ...
        canRename: user && selectedFiles.length === 1 && !isReadOnly && !selectedFiles[0].path.endsWith('.hazmapper'),
        canCopy: user && selectedFiles.length >= 1 && !selectedFiles[0].path.endsWith('.hazmapper'),
        canTrash: user && selectedFiles.length >= 1 && !isReadOnly && !selectedFiles[0].path.endsWith('.hazmapper'),
