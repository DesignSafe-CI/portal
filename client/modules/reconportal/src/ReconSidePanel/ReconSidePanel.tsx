...
export const ReconSidePanel: React.FC<LayoutProps> = ({
  ...
  const {selectedReconPortalEventIdentfier, setSelectedReconPortalEventIdentifier} = useSelectedReconPortalEvent();
  ...
  const selectedEvent = selectedReconPortalEventIdentfier
    ? events.find((event) => getReconPortalEventIdentifier(event) === selectedReconPortalEventIdentfier)
    : null;
